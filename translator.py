...
def process_text(text, target_language, improve_mode=False):
    ...
    Args:
        text (str): The source text to process.
        target_language (str): The desired language for translation.
        improve_mode (bool): If True, improves fluidity before translating.
        
    Returns:
        dict: A dictionary containing detected_language, improved_text (if applicable), and translated_text.
    """
    model = get_model()
